...
//alert('hello');
    ...
    $("#edit_product").validate({  
        ...
        submitHandler: function(form) {
                     ...
                     for (var i=0;i<type_count; i++) 
                     {
                       ...
                       // console.log('sub_type_count : '+$("#sub_type_count_"+i).val());
                            for (var j=0;j<$("#sub_type_count_"+i).val(); j++) 
                           {
                             ...
                             stp_id.push($("[name='outer-group["+i+"][inner-group]["+j+"][sub_type_id]']").val());
              ...
              $.ajax({
                    type: "POST",
                   url: base_url+"admin/product/product_update", 
                   data : formData,
                    dataType:"json",
