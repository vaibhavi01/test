        ...
        submitHandler: function(form) {
          //console.log('jksdjl');
                       ...
                       if(count != '0') 
                       {
                        ...
                        if ($.inArray(fileNameExt, allowedFiles) == -1 || size>5000)
                         ...
                         else
                         {
                            ...
                            $('#files1').next().html('');
                            formData.append("dsn_img", document.getElementById('files1').files[0]);
                         }
                ...
                //********* IMAGE UPLOAD ***********//
                 ...
                 formData.append('dsn_id',document.getElementById('dsn_id').value); 
                // alert('bottom');

              // console.log(formData);
            $.ajax({
                    type: "POST",
                    url: base_url+"admin/designer/dsnUpdate", 
                    data : formData,
                    dataType:"json",
