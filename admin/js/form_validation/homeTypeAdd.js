                ...
                try
                {
                      ...
                      switch(type)
                      {
                        case '5':
                               ...
                               imageMultipleFlag = true;        //image multiple true                               console.log('case slider <<');
                               break;
                        case '6':
                 ...
                 formData.append('typetitleVal',document.getElementById(titleId).value); 

              // console.log(formData);
              $.ajax({
                    type: "POST",
                    url: base_url+"admin/Home/homeTypeAdd", 
                    data : formData,
                    dataType:"json",
